...
import { CheckCircle, AlertTriangle, Settings, Database, Globe, Satellite, Clock, TrendingUp, Shield, Eye, Info } from 'lucide-react';
...
const DataAnalysisSection: React.FC = () => {
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-slate-900 to-slate-800" id="data-analysis">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-yellow-400">
                ...
                <span className="text-lg font-semibold">Atualmente em modo demo</span>
              </div>
              <p className="text-gray-300 ml-9">Precisa ser ativado para usar dados reais</p>
